  ...
  return (
    <>
      ...
      >
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-6 py-32 lg:px-12 xl:px-16">
          <StaggerContainer className="max-w-xl" staggerChildren={0.15}>
            {/* Eyebrow */}
            <StaggerItem direction="up" className="mb-8 flex items-center gap-3">
            ...
            {/* CTAs */}
            <StaggerItem direction="up" className="mt-10 flex flex-wrap items-center gap-5">
              <motion.a
                whileHover={{ scale: 1.02 }}
                whileTap={{ scale: 0.98 }}
                href="#contato"
                className="group inline-flex items-center justify-between gap-8 rounded-full bg-taupe px-8 py-4 font-body text-[13px] font-semibold tracking-[0.12em] text-white uppercase transition-colors duration-200 hover:bg-brown-gold min-w-[280px]"
              >
            ...
            {/* Scroll indicator */}
            <StaggerItem direction="none" className="mt-12 hidden flex-col items-start gap-2 lg:flex">
      ...
      <motion.a
        ...
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-[0_4px_20px_rgba(37,211,102,0.4)] transition-shadow duration-300 hover:shadow-[0_6px_28px_rgba(37,211,102,0.55)]"
      >
        {/* WhatsApp SVG */}
        <svg
